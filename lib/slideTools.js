...
export const SLIDE_TOOL_DEFINITION = {
  ...
  description:
    "Call this when the user asks you to prepare, create, or generate a slide deck, presentation, or PowerPoint. Write the actual real content yourself — a deck title and an array of content slides, each with a heading and specific bullet points — based on everything you actually know about the loaded functions, their overlaps, gaps, ambiguities, and structure issues. Do not use placeholder text; write the real findings as if this deck will be presented as-is.",
  input_schema: {
    type: 'object',
    properties: {
